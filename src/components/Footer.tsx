...
export const Footer: React.FC = () => {
  ...
  const phone = settings?.phone || settings?.alternatePhone || '09828226566';
  const cleanPhone = phone.replace(/[^0-9+]/g, '');
  const email = settings?.email || 'info@jaipurpropertywalaaa.in';
  const address = settings?.address || 'Livasha Flat No.301, Mahal Yojna, Mahal Road Scheme, Jagatpura, Jaipur - 302018, Rajasthan';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-forest-700/60">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-3">
              <a href={fb} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-forest-800 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gold-600 transition-colors" aria-label="Facebook">
              ...
              <a href={insta} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-forest-800 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gold-600 transition-colors" aria-label="Instagram">
              ...
              <a href={yt} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-forest-800 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gold-600 transition-colors" aria-label="YouTube">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href={li} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-forest-800 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gold-600 transition-colors" aria-label="LinkedIn">
