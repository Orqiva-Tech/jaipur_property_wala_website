...
export const WhatsAppFloat: React.FC = () => {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-center space-x-2.5">
      ...
      {/* WhatsApp Trigger */}
      <a
        href="https://api.whatsapp.com/send?phone=919251217568&text=Hello%20Jaipur%20Property%20Wala,%20I%20am%20interested%20in%20JDA%20Approved%20plots%20in%20Jaipur."
        target="_blank"
